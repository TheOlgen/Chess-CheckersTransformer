...
from CheckersDataset import CheckersDataset
...
from CheckersTraining.CheckersDataModule import CheckersDataModule
from CheckersUtils import checkersEvaluator, index_to_move
...
def main():
    # train_ds = CheckersDataset(chunk_size=200)
    # val_ds = CheckersDataset(chunk_size=200)
    #
    ...
    dm = CheckersDataModule(chunk_size=200, records_per_epoch=1000, batch_size=64, num_workers=4)
